...
public class TutorialScreen implements Screen {
    ...
    public TutorialScreen(Game game, Boolean musicpaused/*, AdHandler handler*/){
        ...
        backgroundimage = new Image(new Texture("mongotutorial3.png"));
       ...
       /* Label.LabelStyle font = new Label.LabelStyle(new BitmapFont(), Color.WHITE);
        ...
        Label startGameLabel = new Label("TAP TO BEGIN GAME", font);
        startGameLabel.setFontScale(4);
        table.add(startGameLabel).expandX().padTop(500);*/
    ...
    public void render(float delta) {
        ...
        if(Gdx.input.justTouched()) {
            game.setScreen(new PlayScreen((MongosX) game, pausemusic/*, handler*/));
            dispose();
        }
